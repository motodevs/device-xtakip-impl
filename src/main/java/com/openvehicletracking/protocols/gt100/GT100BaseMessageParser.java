...
import com.openvehicletracking.protocols.gt100.location.GT100LocationMessageBuilder;
...
abstract public class GT100BaseMessageParser implements Parser {
    ...
    protected GpsStatus createGpsStatus(GT100LocationMessageBuilder locationMessageBuilder) {
